        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .hero-card {
            background: linear-gradient(135deg, rgba(30, 41, 59, 0.8) 0%, rgba(15, 23, 42, 0.9) 100%), 
                        url('https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?auto=format&fit=crop&w=1600&q=80') center/cover;
...
<body>
    ...
    <div class="modal" id="quickViewModal">
        <img src="" id="modalImg" class="modal-img" alt="Product Quick View">
        <div style="display:flex; flex-direction:column; justify-content:center;">
            <div id="modalCategory" class="product-category"></div>
            <h2 id="modalTitle" style="margin-bottom:0.5rem; font-size:1.5rem;"></h2>
            <p id="modalDesc" style="color:var(--text-muted); font-size:0.9rem; margin-bottom:1.5rem;"></p>
            <div id="modalPrice" class="product-price" style="font-size:1.5rem; margin-bottom:1.5rem;"></div>
    ...
    <script>
        // Enhanced Product Catalog Data
        const PRODUCTS = [
            { id: 1, title: 'iPhone 14 Pro Max', price: 1099, category: 'phones', rating: 4.9, reviews: 240, img: 'https://images.unsplash.com/photo-1601784551446-20c9e07cdbdb?auto=format&fit=crop&w=600&q=80', desc: 'Dynamic Island, 48MP main camera, and all-day battery life encased in surgical-grade stainless steel.' },
            { id: 2, title: 'MacBook Pro 14"', price: 1999, category: 'laptops', rating: 4.8, reviews: 180, img: 'https://images.unsplash.com/photo-1593642632823-8f785ba67e45?auto=format&fit=crop&w=600&q=80', desc: 'M2 Pro chip delivers groundbreaking performance and exceptional efficiency for intense workflows.' },
            { id: 3, title: 'Sony WH-1000XM5', price: 399, category: 'gadgets', rating: 5.0, reviews: 310, img: 'https://images.unsplash.com/photo-1600185365483-26d7a4cc7519?auto=format&fit=crop&w=600&q=80', desc: 'Industry-leading noise canceling with two processors and eight microphones for unprecedented sound quality.' },
            { id: 4, title: 'Apple Watch Ultra', price: 799, category: 'gadgets', rating: 4.7, reviews: 95, img: 'https://images.unsplash.com/photo-1529374255404-311a2a4f1fd9?auto=format&fit=crop&w=600&q=80', desc: 'Rugged titanium casing, precision dual-frequency GPS, and up to 36 hours of battery life.' },
            { id: 5, title: 'Fujifilm X-T5 Camera', price: 1699, category: 'gadgets', rating: 4.9, reviews: 64, img: 'https://images.unsplash.com/photo-1526170375885-4d8ecf77b99f?auto=format&fit=crop&w=600&q=80', desc: '40MP BSI image sensor with classic dial-based controls for modern photography enthusiasts.' }
        ];
